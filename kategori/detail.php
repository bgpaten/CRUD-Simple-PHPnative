    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6">
                ...
                <h3 class="mt-5 fw-bold">Detail Data Kategori</h3>
                ...
                <div class="card text-bg-dark" style="width: 18rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        <?php
                        foreach ($detail as $kategori) { 
                        ?>
                            <li class="list-group-item">ID : <?= $kategori["id"] ?></li>
                            <li class="list-group-item">Nama Kategori : <?= $kategori["kategori"] ?></li>
                        <?php
                        }
                        ?>
                    </ul>
